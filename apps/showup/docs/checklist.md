...
### 🟨 리드
- [ ] 세션별 2일차 작업 할당 확인, 진행 체크
- [ ] FE ↔ BE 인증 인터페이스 일치 확인

---

## 3일차 (7/13 월) — 고객 CRUD·목록·검색
...
## 5일차 (7/15 수) — 위험도 계산·riskStats 연동
...
## 7일차 (7/17 금) — 대시보드 완성·상태 UI·고객 상세
...
## 8일차 (7/20 월) — 모바일 QA·성능·Lighthouse
