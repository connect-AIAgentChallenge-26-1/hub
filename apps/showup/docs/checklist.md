# ShowUp 작업 체크리스트 (Conductor 4세션 분배)
...
> 세션 분리는 브랜치가 아니라 역할 분리. commit/push/PR은 리드만.
...
- [ ] 시드 데이터 스크립트 (고객 10명, 예약 30건, 사건 5건 — 프론트 mock용)
...
### 🟨 리드
- [ ] 백엔드 API ↔ 프론트 연결 리뷰 (인터페이스 불일치 잡기)
