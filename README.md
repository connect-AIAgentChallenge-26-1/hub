...
- [Linked Live Runbook](docs/runbooks/RUN-0004-recommendation-workflow-linked-live.md): 실제 Naver→Elice 로컬 일회성 검증과 중단
...
- Elice 개별 확인은 별도 격리 task의 합성 Chat·Embedding으로 수행한다. PP-040은
  ...
  연결하는 합성 입력의 로컬 일회성 예외다. 승인 원문은 독립 검토하지 않았으며 제품
